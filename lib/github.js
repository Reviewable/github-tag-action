...
function createTag(newTag, message, createAnnotatedTag, GITHUB_SHA) {
    return __awaiter(this, void 0, void 0, function* () {
        const octokit = getOctokitSingleton();
        let annotatedTag = undefined;
        if (createAnnotatedTag || message) {
            core.debug(`Creating annotated tag.`);
            annotatedTag = yield octokit.git.createTag(Object.assign(Object.assign({}, github_1.context.repo), { tag: newTag, message: message ? message : newTag, object: GITHUB_SHA, type: 'commit' }));
        }
